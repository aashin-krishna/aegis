...
\midrule
1D CNN & 96.12\% & 0.0485 \\
CNN-BiLSTM & 96.76\% & 0.0446 \\
CNN-BiLSTM-Transformer (Standard) & 97.44\% & 0.0326 \\
\textbf{GNN (GCN)} & \textbf{97.92\%} & \textbf{0.0298} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
\textbf{Overall Accuracy} & & & \textbf{98.00\%} & \textbf{626,060} \\
\textbf{Macro Average} & \textbf{0.86} & \textbf{0.97} & \textbf{0.90} & \textbf{626,060} \\
\textbf{Weighted Average} & \textbf{0.99} & \textbf{0.98} & \textbf{0.98} & \textbf{626,060} \\
\bottomrule
\end{tabular}
\end{table}
