...
We evaluated the collaborative agent swarm using 60 simulated APT campaigns. The results of deploying different LLM foundations inside the correlation swarm are summarized in Table~\ref{tab:llm_comparison}.
